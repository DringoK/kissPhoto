 ...
 * @created: 2014-05-04 Created by Ingo on 04.05.2014.
 * @modified: 2014-06-06 Watch Event parameter splitted into filename and kind (otherwise the user would have to do it each time)
 */
